...
public class ModuleService {
	...
	public Module findModuleById(@PathVariable("moduleId") String id) {

		int intId = Integer.parseInt(id);
		
		return moduleRepository.findById(intId).orElse(null);
	}
	...
	public Module updateModule(@PathVariable("moduleId") String moduleId, @RequestBody Module newModule) {
		
		int intId = Integer.parseInt(moduleId);
		
		Module module = moduleRepository.findById(intId).orElse(null);
